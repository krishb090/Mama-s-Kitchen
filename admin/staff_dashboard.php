<?php
    ...
    {
    	include 'Includes/templates/staff_navbar.php';
    ...
    <!-- New Card for Contact Submissions -->
    <div class="col-sm-6 col-lg-3">
        <div class="panel panel-purple">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-sm-9 text-right">
                        <div class="huge"><span><?php echo countItems("id", "contact_submissions")?></span></div>
                        <div>Total Contact Submissions</div>
                    </div>
                </div>
            </div>
            <a href="view_contact_submissions.php">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
